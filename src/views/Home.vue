        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde la primera infancia, los ambientes de aprendizaje juegan un papel fundamental en la formación integral de los niños y niñas. Estos espacios no solo facilitan la adquisición de conocimientos, sino que también promueven la interacción, la creatividad y el desarrollo de habilidades esenciales para la vida. En esta unidad, exploraremos cómo diseñar ambientes educativos efectivos, considerando factores como el uso de recursos didácticos, la estructura del espacio y la adaptación a las necesidades de los estudiantes.
              
              p #[b ¡Prepárese para diseñar ambientes de aprendizaje que transformen la educación infantil y potencien el desarrollo de cada niño y niña!]
